...
const USER_CONFIG = {
  ...
  TIAN_API: {
    ...
    key: 'f514adac87111f9343cbc2d7f48f0292',
  ...
  USERS: [
      ...
      courseSchedule: {
        ...
        courses: {
          ...
          odd: [
            // 例子，周一的课表
            [
              '10:10-10:55 就业指导（时文文）',
              '11:00-11:45 就业指导（时文文）'
            ],
            // 周二
            [
              '10:10-10:55 论文写作（韩新亮）',
              '11:00-11:45 论文写作（韩新亮）',
              '11:50-12:35 论文写作（韩新亮）'
            ],
            // 周三
            [
              '08:20-09:05 就业指导（时文文）',
              '09:10-09:55 就业指导（时文文）',
              '10:10-10:55 形式与政策4（刘樾樾）',
              '11:00-11:45 形式与政策4（刘樾樾）',
              ,
              '14:20-15:05 人力资源综合实训（孟远）',
              '15:10-15:55 人力资源综合实训（孟远）',
              '16:10-16:55 人力资源综合实训（孟远）',
              '17:00-17:45 人力资源综合实训（孟远）'
            ],
            // 周四
            [
              '今天没课~'
    ...
    },
    {
      ...
      // 使用微信测试号：扫码关注你的微信测试号后生成的一段字符串，在测试号后台能看到
      // 使用其他通道时，请严格按照各个通道的教程进行填写
      id: 'SCT192797TC7gNfT6wAby49EAcKB1vSg7m',
      // 使用微信测试号：你想对他发送的模板消息的模板ID
      // 使用其他通道时，请填写 config/template-config.cjs 中某个想要使用的模板的id
      useTemplateId: '0001',
      // 所在省份或城市，也可以不填
